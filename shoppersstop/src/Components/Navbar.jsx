    ...
    <>
      <div className="navbar-main">
        <div className="navbar">
          ...
          <div className="navbar-sec2" onClick={() => router("/")}>
            <img
          ...
          <div className="navbar-sec3">
            ...
            {logged ? (
              ...
              <i
                class="fa-regular fa-circle-user fa-xl user-icon"
      ...
      {show
        ...
        : toggle && <SignUp setToggle={setToggle} setShow={setShow} />}
    </>
  );
};

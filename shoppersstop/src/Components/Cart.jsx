...
const Cart = () => {
    ...
    useEffect(() => {
        if (currentUser?.email) {
            users.forEach((pro) => {
                if (pro.email === currentUser.email) {
                    setCart(pro.cart)
                }
            })
        } else {
            ...
            <div className='cart'>
                ...
                <div className='cart-section'>
                    <div className='cart-left'>
                        <h3 style={{ marginLeft: "20px", letterSpacing: "1px" }}>ITEM <span className='item-count'>({cart?.length})</span></h3>
                                ...
                                cart?.length && cart.map((prod) => (
                                    ...
                                    <div className='cart-container'>
                                        <div className='cart-box'>
                                            <img src={prod.image} alt="err" className='cart-img' />
                                            <div className='cart-left-content'>
                                                <h4 style={{ textTransform: "uppercase" }}>{prod.category}</h4>
                                                <p>{prod.title}</p>
                                                <h4>{prod.price}$</h4>
                                        ...
                                        <div className='remove-btn' onClick={()=>delItem(prod.id)}>REMOVE</div>
                                    </div>
                                ))
                            }
                        </div>
                    ...
                    <div className='cart-right'>
                        <div className="coupon-box">
                            ...
                            <div className='coupon-flex'>
                                <div className='coupun-flex1'>Enter promo code/coupon code</div>
                                <div className='coupun-flex2'>Apply</div>
                            </div>
                        </div>
                        <div className="gift-wrap">
                            <input type="checkbox" className='gift-box' />
                            <span><b>Gift-Wrap</b></span>
                        </div>
                        <div className='summary-box'>


                            <h3 className='total-word'>Order Summary</h3>

                            <div className='summary-lines'>
                                <h4 className='grey'>Sub-Total</h4>
                                <h4>{Math.floor(final)}$</h4>
                            </div>
                            <div className='summary-lines'>
                                <h4 className='grey'>Delivery Charges*</h4>
                                <h4 style={{ color: "green" }}>Free</h4>
                            </div>
                            <div className='summary-lines'>
                                <h4 className='grey'>Offer Discount</h4>
                                <h4>{Math.floor(final/2)}$</h4>
                            </div>


                            <div className='summary-lines btb' >
                                <h2>Total</h2>
                                <h2 style={{ color: "orange" }}>{Math.floor(final)}$</h2>
                            </div>
